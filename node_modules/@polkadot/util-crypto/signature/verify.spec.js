...
const MUL_EC = (0, _util.u8aToHex)((0, _util.u8aConcat)(new Uint8Array([2]), (0, _util.hexToU8a)(SIG_EC)));
describe('signatureVerify', () => {
  beforeEach(async () => {
    await (0, _wasmCrypto.waitReady)();
  });
  it('throws on invalid signature length', () => {
    expect(() => (0, _.signatureVerify)(MESSAGE, new Uint8Array(32), ADDR_ED)).toThrow('Invalid signature length, expected [64..66] bytes, found 32');
  });
  describe('verifyDetect', () => {
    ...
    it('verifies an ecdsa signature', () => {
      expect((0, _.signatureVerify)(MESSAGE, SIG_EC, ADDR_EC)).toEqual({
        crypto: 'ecdsa',
        isValid: true
      });
    });
  ...
  describe('verifyMultisig', () => {
    ...
    it('verifies an ecdsa signature', () => {
      expect((0, _.signatureVerify)(MESSAGE, MUL_EC, ADDR_EC)).toEqual({
        crypto: 'ecdsa',
        isValid: true
      });
    });
