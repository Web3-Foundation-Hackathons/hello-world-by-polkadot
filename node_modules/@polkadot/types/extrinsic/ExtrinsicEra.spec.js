...
describe('ExtrinsicEra', () => {
  ...
  it('decodes an Extrinsic Era with immortal', () => {
    const extrinsicEra = new _ExtrinsicEra.default(registry, new Uint8Array([0]));
  ...
  it('decodes an Extrinsic Era from u8 as mortal', () => {
    const extrinsicEra = new _ExtrinsicEra.default(registry, new Uint8Array([78, 156]));
  ...
  it('decoded from an existing ExtrinsicEra', () => {
    const extrinsicEra = new _ExtrinsicEra.default(registry, new _ExtrinsicEra.default(registry, new Uint8Array([78, 156])));
    expect(extrinsicEra.asMortalEra.period.toNumber()).toEqual(32768);
    expect(extrinsicEra.asMortalEra.phase.toNumber()).toEqual(20000);
  });
  it('encode an Extrinsic Era from Object with blocknumber & period as mortal instance', () => {
    const extrinsicEra = new _ExtrinsicEra.default(registry, {
      current: 1400,
      period: 200
    });
  ...
  it('serializes and de-serializes from JSON', () => {
    ...
    expect(new _ExtrinsicEra.default(registry, json).toU8a()).toEqual(u8a);
  });
  it('creates from an actual valid era', () => {
    const currBlock = 2251519;
    const mortalEra = new _ExtrinsicEra.default(registry, '0xc503').asMortalEra;
  ...
  it('creates for an actual era (2)', () => {
    const mortalEra = new _ExtrinsicEra.default(registry, '0x8502').asMortalEra;
    expect(mortalEra.period.toNumber()).toEqual(64);
    expect(mortalEra.phase.toNumber()).toEqual(40);
  });
  it('creates form an actual era (3)', () => {
    const mortalEra = new _ExtrinsicEra.default(registry, '0x6502').asMortalEra;
    expect(mortalEra.period.toNumber()).toEqual(64);
    expect(mortalEra.phase.toNumber()).toEqual(38);
  });
  it('creates from an actual era, 100 block hash count', () => {
    const mortalEra = new _ExtrinsicEra.default(registry, '0xd607').asMortalEra;
  ...
  it('creates from a actual 2400 block hash count', () => {
    const mortalEra = new _ExtrinsicEra.default(registry, '0x9be3').asMortalEra;
